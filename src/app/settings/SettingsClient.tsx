...
export default function SettingsClient({ totalWords }: SettingsClientProps) {
        ...
        >
          <Card className="p-6">
            <div className="space-y-6">
              <div>
                <label className="text-sm font-medium mb-2 block">학습 세션 크기</label>
                ...
                <p className="text-xs text-gray-500 mt-2">한 세션에 학습할 단어 개수를 설정합니다.</p>
              </div>
        ...
        >
          <Card className="p-6">
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-500">총 {totalWords}개 단어 수록</p>
            </div>
          </Card>
        </motion.div>
      </div>
